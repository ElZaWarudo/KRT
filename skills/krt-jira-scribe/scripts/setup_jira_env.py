#!/usr/bin/env python3
"""Create a project-local Jira Scribe env file behind a deterministic ignore rule."""
...
EXAMPLE_CONTENT = """JIRA_HOST=jira.example.com
        ...
        json.dumps(
            {
                ...
                "message": "Fill jira-scribe.env locally; do not commit real Jira credentials.",
            }
        )
    )
    return 0
