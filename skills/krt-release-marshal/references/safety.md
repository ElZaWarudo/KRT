...
- Ask before push, force-with-lease push, PR creation/update, PR comment, reviewer request, Jira mutation, or merge unless an accepted plan or active autonomous ledger covers the exact mutation class.
